...
**1.26.2** 面向 **Ubuntu 24.04 x86_64**，从 [本仓库 Releases](https://github.com/Zjj-Low-Key/RackTop-Linux/releases) 下载 `.deb`（推荐）或 `.AppImage`。安装、构建、数据目录及验证说明见 [Linux 使用说明](docs/LINUX.md)。
